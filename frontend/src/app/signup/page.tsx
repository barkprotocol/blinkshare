    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-white pt-20">
        <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md mx-4 sm:mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-center">Sign up. It's free!</h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full ${acceptedTerms && !loading ? "bg-black" : "bg-gray-300 cursor-not-allowed"} text-white text-lg font-semibold py-3 rounded-lg transition duration-300`}
            >
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full flex justify-center items-center bg-white border border-gray-300 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
