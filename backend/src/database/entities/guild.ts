import { Entity, Column, OneToMany, PrimaryColumn, UpdateDateColumn, Index } from 'typeorm';
import { Role } from './role';
import { BaseEntity } from './base-entity';

@Entity()
@Index('useUsdc_idx', ['useUsdc'])
@Index('hidden_idx', ['hidden'])
@Index('notificationChannelId_idx', ['notificationChannelId'])
